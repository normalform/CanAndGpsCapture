...
namespace Canable.Tests
{
    ...
    public class DeviceCanIdTests
    {
        ...
        {
            // Act
            var canId = new DeviceCanId(rawId);
        ...
        public void CanId_StandardCanId_CreatesStandardId()
        {
            ...
            // Act
            var canId = DeviceCanId.StandardCanId(id);
        ...
        public void CanId_ExtendedCanId_CreatesExtendedId()
        {
            ...
            // Act
            var canId = DeviceCanId.ExtendedCanId(id);
        ...
        public void CanId_StandardCanId_WithRtrAndError()
        {
            ...
            // Act
            var canId = DeviceCanId.StandardCanId(id, rtr: true, error: true);
        ...
        public void CanId_ExtendedCanId_WithRtrAndError()
        {
            ...
            // Act
            var canId = DeviceCanId.ExtendedCanId(id, rtr: true, error: true);
