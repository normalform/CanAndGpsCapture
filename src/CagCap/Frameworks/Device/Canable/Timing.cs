            ...
            uint PhaseSeg2)
    {
        ...
        public static List<Timing> Timings { get; } =
            [
                ...
                // sample point: 50.0%
                new Timing(16000000,   10000, 520, 64, 11, 12),
                new Timing(16000000,   20000, 500, 50,  6,  8),
                new Timing(16000000,   50000, 500, 20,  6,  8),
                new Timing(16000000,   83333, 500, 12,  6,  8),
                new Timing(16000000,  100000, 500, 10,  6,  8),
                new Timing(16000000,  125000, 500,  8,  6,  8),
                new Timing(16000000,  250000, 500,  4,  6,  8),
                new Timing(16000000,  500000, 500,  2,  6,  8),
                new Timing(16000000,  800000, 500,  1,  8, 10),
                new Timing(16000000, 1000000, 500,  1,  6,  8),

                // sample point: 62.5%
                new Timing(16000000,   10000, 625, 64, 14,  9),
                new Timing(16000000,   20000, 625, 50,  8,  6),
                new Timing(16000000,   50000, 625, 20,  8,  6),
                new Timing(16000000,   83333, 625, 12,  8,  6),
                new Timing(16000000,  100000, 625, 10,  8,  6),
                new Timing(16000000,  125000, 625,  8,  8,  6),
                new Timing(16000000,  250000, 625,  4,  8,  6),
                new Timing(16000000,  500000, 625,  2,  8,  6),
                new Timing(16000000,  800000, 625,  1, 11,  7),
                new Timing(16000000, 1000000, 625,  1,  8,  6),
            
                // sample point: 75.0%
                new Timing(16000000,   20000, 750, 50, 10,  4),
                new Timing(16000000,   50000, 750, 20, 10,  4),
                new Timing(16000000,   83333, 750, 12, 10,  4),
                new Timing(16000000,  100000, 750, 10, 10,  4),
                new Timing(16000000,  125000, 750,  8, 10,  4),
                new Timing(16000000,  250000, 750,  4, 10,  4),
                new Timing(16000000,  500000, 750,  2, 10,  4),
                new Timing(16000000,  800000, 750,  1, 13,  5),
                new Timing(16000000, 1000000, 750,  1, 10,  4),
                
                // sample point: 87.5%
                new Timing(16000000,   20000, 875, 50, 12,  2),
                new Timing(16000000,   50000, 875, 20, 12,  2),
                new Timing(16000000,   83333, 875, 12, 12,  2),
                new Timing(16000000,  100000, 875, 10, 12,  2),
                new Timing(16000000,  125000, 875,  8, 12,  2),
                new Timing(16000000,  250000, 875,  4, 12,  2),
                new Timing(16000000,  500000, 875,  2, 12,  2),
                new Timing(16000000,  800000, 900,  2,  7,  1),
                new Timing(16000000, 1000000, 875,  1, 12,  2)
            ];
    }
